...
Ans: I selected one location in El Paso, and tried to plot the nearest station data which is El Paso, I saw during different time period there are missing data in this station. So, from this station, rainfall trend prediction can be challenging.
