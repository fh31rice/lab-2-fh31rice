...
That means, scale parameter actually determines the spread of the curve, with increased sigma, the range in y axis(Return level) increases.
...
Ans: The graph shows that the red dot follows closely with the blue line. That means GEV is representing well to the closest station data, but the maximum deviation seems to happen to the increased return period where GEV underestimate the station data.
